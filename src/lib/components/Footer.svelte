	...
	<div class="max-w-6xl p-4 pb-8 mx-auto flex flex-col gap-2 text-slate-400">
		<div class="flex flex-wrap justify-between items-center py-2">
			...
			<div class="flex items-center gap-4 text-slate-300">
				<a href="https://www.linkedin.com/in/shiyueying/">
					<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
				...
				<a href="mailto:y.shi1@student.tue.nl"> <Icon src={Envelope} mini size="24" /></a>
			</div>
		</div>
		<div class="w-full h-[2px] bg-slate-200" />
		<p class="w-full text-sm text-center">© 2022 Yueying Shi all rights reserved.</p>
	</div>
</footer>
