...
<div class="flex gap-12">
	...
	<div class="max-w-4xl">
		...
		<Chapter id="Introduction">
			...
			<p>
				The fast-paced advancements in virtual technology, networks, and computing power contribute
				to the immersive development of virtual environments (VE). Achieving a much higher sense of
				presence now become possible. Just like what we have seen in the sci-fi movies.
			</p>
			<p>
				But first of all, what is presence? After ages of discussion, recently the researcher start
				to define that "Presence is illusion of non-mediation". where users consciously immerse
				themselves in the virtual world, ignoring the mediation interface.
			</p>
			<Quotation author="Lombard M., Ditton T. (1997)">
				<p>
					Presence is an “illusion of non-mediation” that occurs when a person fails to perceive or
			...
			<p>
				...
				and the simulation world. When the people feeling presence, they would full into the
				illusion, the existing of the vr glass would become transparent or disappear for them.
			</p>
			...
			<ul class="list-decimal pl-6 text-slate-600">
				...
				<li>
					...
					comparing presence estimates across different studies and virtual environments. This
					absence of a consistent metric poses challenges in making meaningful comparisons and
					drawing reliable conclusions about presence in VEs.
				</li>
			</ul>

			<p>
				To overcome this, a Rasch-based approach by Haans and IJsselsteijn is introduced. It treats
				indicators (e.g., self-reports, physiological measures) as reflective of presence, offering
				a standardized solution through an item bank. This approach ensures independence of item
				difficulty and individual presence levels, allowing for a test-free assessment. Indicators
				are selected based on a perfect fit with the Rasch model. The study demonstrates the
				feasibility of cross-study comparisons and builds an item bank for VE presence measurement
			...
			<p>
				...
				indicators for measuring presence in virtual environments (VEs). Items demonstrating good
				fit are identified through infit and outfit measurements. Scale equating ensures
			...
			<ul class="list-decimal pl-6">
				...
				<li>
					Do the two VEs differ in the presence they elicit? The convergence validity between the
					new method and the already empirically validated IPQ questionnaire is necessary for the
		...
		<Chapter id="Methods">
			...
			<p>
				...
				were randomly selected from the JSF participant database via email, required to be aged 18
				to 65 without eye disease, and were cautioned against participating if prone to motion
				sickness in virtual environments. Compensation of €7.50 was provided, with an extra €2.00
				for non-TU/e or Fontys participants to cover travel expenses.
			</p>
			<Divider />
			...
			<p>
				...
				participants were recruited for the pit VE, resulting in 42 participants for pit VE and 40
				for street VE. The study employed a two-condition between-subject design, measuring presence
				with distinct item sets in pit and street VEs.
			</p>
			<Divider />
			...
			<p>
				Participants experienced VEs through an HTC VIVE headset, simulating natural walking with
				VIVE controllers. A high-resolution camera recorded behavioral data, and GSR data were
				measured using the Mobi8 device. The experiment received ethical approval from the Ethical
				Review Board of Eindhoven University of Technology.
			</p>
			<div class="flex gap-4 py-4">
			...
			<p>
				...
				form, which described the general purpose and procedures of the experiment and mentioned
				that their behavioral and physiological data would be recorded. Participants were then
				assigned to one of the two VEs.
			</p>
			<h5>Pit</h5>
			<ul class="list-decimal pl-6">
